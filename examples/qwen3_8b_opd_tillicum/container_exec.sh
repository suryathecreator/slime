...
PASS_ENV=(
  ...
  HARP_PYTHON_HEADER_SOURCE
  HARP_ZIG_INCLUDE_ROOT
  HARP_ZIG_CC
  HARP_SCORER_VERSION
  HARP_EXCLUSION_MANIFEST
  HARP_V3_RESCORE_DIR
  HARP_V3_CORRECTION_REPORT_DIR
  HARP_V3_SOURCE_MANIFEST
  AIME_DATASET_REPO
  AIME_DATASET_REVISION
  AIME_SOURCE_DIR
  AIME_PARQUET
  AIME_JSONL
  AIME_PREP_METADATA
  ...
  SFT_TORCH_COMPILE_CC
  SFT_TORCH_COMPILE_CPATH
  SFT_ACTOR_GPUS
  ...
  OPD_TEACHER_CHUNKED_PREFILL_SIZE
  OPD_TEACHER_MAX_PREFILL_TOKENS
  ...
  OPD_ROLLOUT_AUDIT_JSONL
  OPD_ROLLOUT_AUDIT_JSON
  OPD_ROLLOUT_AUDIT_MD
  ...
  EVAL_TUNING_FILE
  EVAL_MAX_NUM_SEQS
  EVAL_PREFER_CUDA_GRAPH
  EVAL_4B_BASE_DIR
  EVAL_32B_BASE_DIR
  EVAL_STUDENT_BASE_DIR
  EVAL_TEACHER_BASE_DIR
  EVAL_OPD1K_DIR
  EVAL_OPD5120_DIR
  BASE_REPORT_DIR
  OPD1K_REPORT_DIR
