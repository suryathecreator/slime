...
export SFT_NUM_ROLLOUT="${SFT_NUM_ROLLOUT:-$(((SFT_SIZE + SFT_ROLLOUT_BATCH_SIZE - 1) / SFT_ROLLOUT_BATCH_SIZE))}"
...
export OPD_NUM_ROLLOUT="${OPD_NUM_ROLLOUT:-$(((OPD_SIZE + OPD_ROLLOUT_BATCH_SIZE - 1) / OPD_ROLLOUT_BATCH_SIZE))}"
export OPD_FINAL_ROLLOUT_ID="${OPD_FINAL_ROLLOUT_ID:-$((OPD_NUM_ROLLOUT - 1))}"
export OPD_MILESTONE_ROLLOUT_IDS="${OPD_MILESTONE_ROLLOUT_IDS:-15 31 47 63 ${OPD_FINAL_ROLLOUT_ID}}"
export OPD_MAX_RESPONSE_LEN="${OPD_MAX_RESPONSE_LEN:-16384}"
export OPD_MAX_TOKENS_PER_GPU="${OPD_MAX_TOKENS_PER_GPU:-16384}"
export OPD_SAVE_INTERVAL="${OPD_SAVE_INTERVAL:-16}"
