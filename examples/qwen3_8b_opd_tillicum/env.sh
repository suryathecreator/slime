...
export SFT_HF_SNAPSHOT_TEMPLATE="${SFT_HF_SNAPSHOT_TEMPLATE:-${SFT_HF_SNAPSHOT_DIR}/iter_{rollout_id:07d}}"
...
export OPD_HF_SNAPSHOT_TEMPLATE="${OPD_HF_SNAPSHOT_TEMPLATE:-${OPD_HF_SNAPSHOT_DIR}/iter_{rollout_id:07d}}"
