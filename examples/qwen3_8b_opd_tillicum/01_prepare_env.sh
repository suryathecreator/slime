...
Data
  ...
  OPD_JSONL=${OPD_JSONL}
  OPD_POOL_SIZE=${OPD_POOL_SIZE}
  OPD_TRAIN_SIZE=${OPD_TRAIN_SIZE}
  OPD_EFFECTIVE_TRAIN_SAMPLES=${OPD_EFFECTIVE_TRAIN_SAMPLES}
...
Outputs
  ...
  OPD_TRAINED_MANIFEST=${OPD_TRAINED_MANIFEST}
  ...
  COMBINED_EVAL_OUTPUT_DIR=${COMBINED_EVAL_OUTPUT_DIR}
