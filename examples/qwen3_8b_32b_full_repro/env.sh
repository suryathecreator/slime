...
export OPD_TORCH_COMPILE_CC="${OPD_TORCH_COMPILE_CC:-${EVAL_ZIG_CC}}"
export OPD_TORCH_COMPILE_CPATH="${OPD_TORCH_COMPILE_CPATH:-${EVAL_ZIG_INCLUDE_ROOT}/python3.12:${EVAL_ZIG_INCLUDE_ROOT}}"
...
export EVAL_CAP_PROXY_TARGET_CONTEXT=32768
export EVAL_CAP_PROXY_MAX_NUM_SEQS=21
export EVAL_CAP_PROXY_MAX_NUM_BATCHED_TOKENS=16384
