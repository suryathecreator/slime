...
def main() -> None:
    ...
    sources = {
        ...
        Path(os.environ["MANIFEST_ROOT"]) / "scorer_v2_rescore_submission.json": repo_dir / "SCORER_RESCORE_SUBMISSION.json",
        Path(os.environ["MANIFEST_ROOT"]) / "scorer_v3_final_submission.json": repo_dir / "SCORER_V3_RESCORE_SUBMISSION.json",
        output_root / "final_report" / "MATH500_SCORER_AUDIT.json": repo_dir / "MATH500_SCORER_AUDIT.json",
        output_root / "final_report" / "MATH500_SCORER_AUDIT.md": repo_dir / "MATH500_SCORER_AUDIT.md",
        output_root / "final_report" / "MATH500_SCORER_V3_AUDIT.json": repo_dir / "MATH500_SCORER_V3_AUDIT.json",
        output_root / "final_report" / "MATH500_SCORER_V3_AUDIT.md": repo_dir / "MATH500_SCORER_V3_AUDIT.md",
