...
submit_serial prepare_qwen3_0p6b_model "${SCRIPT_DIR}/00_prepare_model.sbatch"
submit_serial prepare_qwen3_0p6b_data "${SCRIPT_DIR}/01_prepare.sbatch"
submit_serial canary_qwen3_0p6b_custom_and_stock "${SCRIPT_DIR}/02_canary.sbatch"
submit_serial score_qwen3_0p6b_margins_and_build "${SCRIPT_DIR}/03_score_and_build.sbatch"
for variant in \
  ...
  submit_serial "train_qwen3_0p6b_2k_${variant}" \
    --job-name="q3-06b-${variant}" \
