...
export HARP_SCORER_VERSION="${HARP_SCORER_VERSION:-harp_answer_v2}"
export HARP_EXCLUSION_MANIFEST="${HARP_EXCLUSION_MANIFEST:-${HARP_EXAMPLE_DIR}/harp_exclusions_v3.json}"
...
export VLLM_EVAL_4B_MAX_NUM_SEQS=20
export VLLM_EVAL_32B_MAX_NUM_SEQS=6
...
export HARP_V3_RESCORE_DIR="${EVAL_4B_BASE_DIR}/rescore_harp_answer_v3"
export HARP_V3_CORRECTION_REPORT_DIR="${OUTPUT_ROOT}/reports/harp_v2_v3_correction"
export HARP_V3_SOURCE_MANIFEST="${SCRATCH_ROOT}/source_manifest_harp_v3.sha256"
