...
export REPLICATE_DIR
REPLICATE_DIR="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" >/dev/null 2>&1 && pwd)"
export SLIME_REPO_ROOT
SLIME_REPO_ROOT="$(cd -- "${REPLICATE_DIR}/../.." >/dev/null 2>&1 && pwd)"
export PYTHONPATH="${SLIME_REPO_ROOT}${PYTHONPATH:+:${PYTHONPATH}}"

export CONTRACT_FILE="${REPLICATE_DIR}/config/experiment_contract.json"
export CONTRACT_HASH
CONTRACT_HASH="$(sha256sum "${CONTRACT_FILE}" | awk '{print substr($1,1,16)}')"
export SCRATCH_ROOT="/gpfs/scrubbed/suryadv/slime-qwen2-5-7b-correct-recipe-random-mask-replicates-sft-2k"
...
export SOURCE_CONTRACT_HASH="07291674d43cf3da"
export SOURCE_EXPERIMENT_ROOT="/gpfs/scrubbed/suryadv/slime-qwen2-5-7b-correct-recipe-masked-sft-2k/v1/${SOURCE_CONTRACT_HASH}"
export SOURCE_UNMASKED_JSONL="${SOURCE_EXPERIMENT_ROOT}/data/unmasked_2000.jsonl"
export SOURCE_PREP_STATS="${SOURCE_EXPERIMENT_ROOT}/data/selection_and_tokenization_stats.json"
export SOURCE_TOKENIZER_INVENTORY="${SOURCE_EXPERIMENT_ROOT}/data/tokenizer_control_inventory.json"
export SOURCE_SCHEDULE_AUDIT="${SOURCE_EXPERIMENT_ROOT}/data/schedule_audit.json"
export SOURCE_TRAINING_STATUS="${SOURCE_EXPERIMENT_ROOT}/TRAINING_STATUS.json"
export SOURCE_COMPARISON_SOURCES="${SOURCE_EXPERIMENT_ROOT}/handoff/comparison_sources.json"
...
export RANDOM_MASK_05_SEED42_JSONL="${DATA_ROOT}/random_mask_05_seed42_2000.jsonl"
export RANDOM_MASK_15_SEED42_JSONL="${DATA_ROOT}/random_mask_15_seed42_2000.jsonl"
export RANDOM_MASK_05_SEED43_JSONL="${DATA_ROOT}/random_mask_05_seed43_2000.jsonl"
export RANDOM_MASK_15_SEED43_JSONL="${DATA_ROOT}/random_mask_15_seed43_2000.jsonl"
export RANDOM_MASK_05_SEED44_JSONL="${DATA_ROOT}/random_mask_05_seed44_2000.jsonl"
export RANDOM_MASK_15_SEED44_JSONL="${DATA_ROOT}/random_mask_15_seed44_2000.jsonl"
...
export SFT_WANDB_PROJECT="slime-openr1-correct-recipe-random-mask-replicates-sft"
export SFT_WANDB_GROUP="qwen2.5-7b-correct-recipe-random-mask-replicates"
...
variant_data_path() {
  case "${1:?variant required}" in
    random_mask_05_seed42) echo "${RANDOM_MASK_05_SEED42_JSONL}" ;;
    random_mask_15_seed42) echo "${RANDOM_MASK_15_SEED42_JSONL}" ;;
    random_mask_05_seed43) echo "${RANDOM_MASK_05_SEED43_JSONL}" ;;
    random_mask_15_seed43) echo "${RANDOM_MASK_15_SEED43_JSONL}" ;;
    random_mask_05_seed44) echo "${RANDOM_MASK_05_SEED44_JSONL}" ;;
    random_mask_15_seed44) echo "${RANDOM_MASK_15_SEED44_JSONL}" ;;
